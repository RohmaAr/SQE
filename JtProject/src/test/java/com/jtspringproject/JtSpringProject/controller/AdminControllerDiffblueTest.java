...
class AdminControllerDiffblueTest {
    ...
    /**
     * Method under test: {@link AdminController#showHomePage()}
     */
    @Test
    void testShowHomePage() {
        ...
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        //   javax.servlet.ServletException: Circular view path [homepage]: would dispatch back to the current handler URL [/admin/homepage] again. Check your ViewResolver setup! (Hint: This may be the result of an unspecified view, due to default view name generation.)
        //       at javax.servlet.http.HttpServlet.service(HttpServlet.java:655)
        //       at javax.servlet.http.HttpServlet.service(HttpServlet.java:764)
        //   See https://diff.blue/R013 to resolve this issue.

        assertEquals("homepage", (new AdminController()).showHomePage());
    }
    ...
    /**
     * Method under test: {@link AdminController#handleError()}
     */
    @Test
    void testHandleError() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/admin/handleError");
        MockMvcBuilders.standaloneSetup(adminController)
                .build()
                .perform(requestBuilder)
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    void testProfileDisplay() throws Exception {
        ...
        MockMvcBuilders.standaloneSetup(adminController)
                ...
                .andExpect(MockMvcResultMatchers.forwardedUrl("userinfo"));
    }
    ...
    void testUpdateProduct() throws Exception {
        ...
        MockMvcBuilders.standaloneSetup(adminController)
                ...
                .andExpect(MockMvcResultMatchers.model().attributeExists("categories", "products"))
