		...
		<form action="/products/update/${product.id}" method="post">
			<div class="row">
				<div class="col-sm-5">
					...
					<div class="form-group">
						<%--@declare id="category"--%><label for="category">Select Category</label>
					...
					<div class="form-group">
						<%--@declare id="weight"--%><label for="weight">Weight in grams</label>
				...
				<div class="col-sm-5">
					<div class="form-group">
						<%--@declare id="description"--%><label for="description">Product Description</label>
